...
const formatDriverRecord = (drv) => ({
  ...
  acceptanceRate: parseFloat(drv.acceptance_rate || (drv.id === 'drv_1' ? 98 : (drv.id === 'drv_2' ? 88 : 78))),
  cancellationRate: parseFloat(drv.cancellation_rate || (drv.id === 'drv_1' ? 2 : (drv.id === 'drv_2' ? 5 : 12))),
  speed: parseFloat(drv.speed || 35),
...
server.listen(port, '127.0.0.1', () => {
  console.log(`JoldiGo Full-Stack Backend Server running on http://127.0.0.1:${port}`);
  console.log(`WebSocket Service Listening on ws://127.0.0.1:${port}`);
});
